...
/**
 * @brief InputHandlerPanning::InputHandlerPanning
 * @param graph
 * @param parent
 * Code is used from Axis Range Dragging With Labels Example
 * https://doc.qt.io/archives/qt-5.10/
 * qtdatavisualization-draggableaxes-example.html
 */
...
void InputHandlerPanning::setAxes(QValue3DAxis *axisX,
...
void InputHandlerPanning::mousePressEvent(QMouseEvent *event,
...
void InputHandlerPanning::mouseMoveEvent(QMouseEvent *event,
                                         const QPoint &mousePos)
{
...
void InputHandlerPanning::mouseReleaseEvent(QMouseEvent *event,
                                            const QPoint &mousePos)
{
...
void InputHandlerPanning::handleElementSelected(
...
void InputHandlerPanning::handleAxisDragging()
{
  ...
  case StateDraggingZ:
    ...
    break;
  case StateDraggingY:
    distance = move.y() / m_speedModifier; // No need to use adjusted y move
